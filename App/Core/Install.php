...
class Install {
    ...
    private function db_iran() {
        ...
        return " CREATE TABLE IF NOT EXISTS  `$table_name` (
                    ...
                    PRIMARY KEY (`id`)
                    ) ENGINE=InnoDB AUTO_INCREMENT=1151 DEFAULT CHARSET=utf8mb4 COLLATE={$this->collate}";
    }

    private function insert_iran() {
        $table_name = $this->prefix( 'iran' );

        $sql = "
        INSERT INTO `wp_tai_iran` (`id`, `name`, `province_id`) VALUES
            (1, 'آذربایجان شرقی', 0),
            (2, 'آذربایجان غربی', 0),
            (3, 'اردبیل', 0),
            (4, 'اصفهان', 0),
