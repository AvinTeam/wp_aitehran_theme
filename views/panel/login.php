        ...
        <div class="d-flex flex-column-reverse flex-lg-row justify-content-between row-gap-4 row-gap-lg-0">
            ...
            <div class="col-12 col-lg-8 px-2 ">
                ...
                <section class="d-flex flex-column row-gap-3 w-100 bg-gray rounded-65 py-40 px-100 ">
                    ...
                    <form id="loginForm">
                        <div id="mobileForm" class="d-flex flex-column row-gap-2">
                            <div class="d-flex flex-column row-gap-2 " >
                                <label class="f-24 fw-bold" for="mobile">شماره تماس</label>
                                <input type="text" inputmode="numeric" pattern="\d*"
                                class="d-ltr px-2 onlyNumbersInput w-100 rounded-32 overflow-hidden border-1 border border-black f-24 fw-bold"
                            ...
                            <div class="d-flex flex-column row-gap-2 ">
                                ...
                                class="w-100 rounded-32 overflow-hidden border-1 border border-black f-24 fw-bold d-ltr px-2" >
                            </div>
                            <button id="send-code" class="btn btn-warning fw-bold f-20 mt-5 mb-3 rounded-40" type="submit" disabled>ارسال کد امنیتی به شماره همراه</button>
                        </div>
                        <div id="codeVerification" style="display: none;">
                            <input autocomplete="one-time-code" type="text" inputmode="numeric" pattern="\d*"
                                class="onlyNumbersInput" id="verificationCode" placeholder="کد تایید را وارد کنید"
